...
# 微服务访问接口更新
SEARCH_API_URL = 'https://appc.netsage.click/api/v1/plgi/search'
CRAWL_API_URL = 'https://appc.netsage.click/api/v1/plgi/crawl'
SEARCH_CRAWL_API_URL = 'https://appc.netsage.click/api/v1/plgi/search-crawl'
